...
import 'package:video_call/common/app_bar/recording_indicator.dart';
import 'package:video_call/common/chat/chat_view.dart';
import 'package:video_call/common/participant/participant_list.dart';
import 'package:video_call/common/screen_share/screen_select_dialog.dart';
import 'package:video_call/constants/colors.dart';
import 'package:video_call/utils/api.dart';
import 'package:video_call/utils/spacer.dart';
import 'package:video_call/utils/toast.dart';
            ...
            child: TouchRippleEffect(
              ...
              child: Container(
                ...
                child: SvgPicture.asset(
                  "packages/video_call/assets/ic_recording.svg",
                  width: 23,
                  height: 23,
                  color: Colors.white,
                ),
              ...
              child: Container(
                ...
                child: SvgPicture.asset(
                  widget.isLocalScreenShareEnabled
                      ? "packages/video_call/assets/ic_stop_screen_share.svg"
                      : "packages/video_call/assets/ic_screen_share.svg",
                  color: Colors.white,
                ),
              ),
            ),
          ...
          Padding(
            ...
            child: TouchRippleEffect(
              ...
              child: Container(
                ...
                padding: const EdgeInsets.all(11),
                child: SvgPicture.asset(
                  "packages/video_call/assets/ic_chat.svg",
                  width: 23,
                  height: 23,
                  color: Colors.white,
                ),
            ...
            child: PopupMenuButton(
                ...
                itemBuilder: (context) => <PopupMenuEntry>[
                      _buildMeetingPoupItem(
                        ...
                        leadingIcon: SvgPicture.asset("packages/video_call/assets/ic_leave.svg"),
                      ),
                      ...
                      _buildMeetingPoupItem(
                        ...
                        leadingIcon: SvgPicture.asset("packages/video_call/assets/ic_end.svg"),
                      ),
                    ]),
          ),
        ],
