          ...
          PopupMenuButton(
              ...
              itemBuilder: (context) => <PopupMenuEntry>[
                    _buildMeetingPoupItem(
                      ...
                      SvgPicture.asset("packages/video_call/assets/ic_leave.svg"),
                    ),
                    ...
                    _buildMeetingPoupItem(
                      ...
                      SvgPicture.asset("packages/video_call/assets/ic_end.svg"),
                    ),
                  ]),
          ...
          TouchRippleEffect(
            ...
            child: Container(
              ...
              child: SvgPicture.asset(
                isCamEnabled
                    ? "packages/video_call/assets/ic_video.svg"
                    : "packages/video_call/assets/ic_video_off.svg",
                width: 26,
                height: 26,
                    ...
                    _buildMeetingPoupItem(
                      ...
                      recordingState == "RECORDING_STARTED"
                          ...
                          : recordingState == "RECORDING_STARTING"
                              ...
                              : "Start Recording",
                      null,
                      SvgPicture.asset("packages/video_call/assets/ic_recording.svg"),
                    ),
                    const PopupMenuDivider(),
                    _buildMeetingPoupItem(
                      "screenshare",
                      isScreenShareEnabled
                          ...
                          : "Start Screen Share",
                      null,
                      SvgPicture.asset("packages/video_call/assets/ic_screen_share.svg"),
                    ),
                    const PopupMenuDivider(),
                    _buildMeetingPoupItem(
                      "participants",
                      "Participants",
                      null,
                      SvgPicture.asset("packages/video_call/assets/ic_participants.svg"),
                    ),
                  ]),
        ],
      ),
