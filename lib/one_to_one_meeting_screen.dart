...
import 'common/joining/participant_limit_reached.dart';
...
import 'one-to-one/one_to_one_meeting_container.dart';
  ...
  void registerMeetingEvents(Room _meeting) {
    ...
    _meeting.on(Events.roomLeft, (String? errorMsg) {
      ...
      Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(builder: (context) =>  JoinScreen(username:widget.displayName,meetingId: widget.meetingId,)),
          (route) => false);
    });
